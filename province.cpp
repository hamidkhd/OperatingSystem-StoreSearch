...
{   
    ...
    std::vector <std::string> cities = find_directory_contents(&out_unnamed_pipe[1][0]);
    ...
    for (int i = 0; i < cities.size(); i++)
	{
        ...
        {   
            ...
            string address = prev_address + "/" + cities[i];
        ...
        else if (pid == 0)
        {
            ...
            execl("./city.out", "city.cpp", temp_unnamed_pipe.c_str(), NULL);
        }
	}
