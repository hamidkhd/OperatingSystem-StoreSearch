...
int main(int argc, char *argv[])
{
    ...
    std::vector <std::string> province = find_directory_contents(&out_unnamed_pipe[1][0]);
    ...
    for (int i = 0; i < province.size(); i++)
	{
        ...
        {   
            ...
            string address = prev_address + "/" + province[i];
        ...
        else if (pid == 0)
        {
            ...
            execl("./province.out", "province.cpp", temp_unnamed_pipe.c_str(), NULL);
        }
	}
